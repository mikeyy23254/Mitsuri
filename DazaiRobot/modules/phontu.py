...
from DazaiRobot.utils.resources.ImageEditor.edit_2 import (
    cartoon, circle_with_bg, circle_without_bg, contrast, edge_curved, pencil,
    sepia_mode, sticker,
)
from DazaiRobot.utils.resources.ImageEditor.edit_3 import (
    black_border, blue_border, green_border, red_border,
)
from DazaiRobot.utils.resources.ImageEditor.edit_4 import (
    inverted, removebg_plain, removebg_sticker, removebg_white, rotate_90,
    rotate_180, rotate_270, round_sticker,
)
from DazaiRobot.utils.resources.ImageEditor.edit_5 import (
