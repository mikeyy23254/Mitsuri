...
def welcomepic(pic, user, chat, id, uname):
    ...
    draw.text((20, 40), f'NAME: {unidecode(user)}', fill=(100, 100, 100), font=font)
    draw.text((30, 70), f'ID: {id}', fill=(100, 100, 100), font=font)
    draw.text((30, 10), f"Welcome to {unidecode(chat)}", fill=(100, 100, 100), font=welcome_font)
    draw.text((30,100), f"USERNAME : {uname}", fill=(100,100,100),font=font)
    pfp_position = (300, 120)  
